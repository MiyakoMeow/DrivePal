...
class SummaryAdapter:
    ...
    def add(self, history_text: str, **kwargs: AdapterKwargs) -> BaselineMemory:
        ...
        if not agent_client:
            return BaselineMemory(memory_type=VMBMode.SUMMARY)
        ...
        return BaselineMemory(memory_type=VMBMode.SUMMARY, memory_text=mem_text)

    def get_search_client(self, store: BaselineMemory) -> None:
        """不支持搜索客户端."""
        msg = "SummaryAdapter does not support search client"
