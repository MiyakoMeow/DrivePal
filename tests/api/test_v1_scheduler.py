...
def test_trigger_scheduler(app_client: TestClient) -> None:
    """POST /api/v1/scheduler/trigger 成功触发。"""
...
def test_trigger_scheduler_not_running(app_client: TestClient) -> None:
