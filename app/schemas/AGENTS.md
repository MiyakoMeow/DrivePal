...
- **ProcessQueryResult**: status (delivered/pending/suppressed), event_id, session_id, result (dict | None), pending_reminder_id, trigger_text, reason, cancelled (bool | None)
