...
| Strategy | 是否/何时/如何提醒，考虑个性化 + 安全边界 | JSON 决策（10 字段：should_remind/timing/is_emergency/target_time/delay_seconds/reminder_content/type/reason/allowed_channels/action/postpone），通道由规则引擎约束非 LLM 输出 |
